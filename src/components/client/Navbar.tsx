    ...
    return (
      <header className="fixed top-0 left-0 w-full z-50 bg-white/30 backdrop-blur-xl border-white/20 shadow-md">
        ...
        <nav className="container mx-auto flex justify-between items-center px-6 py-4 ">
          ...
          {/* links */}
          <ul
            className={`flex flex-col lg:flex-row absolute lg:static top-full left-0 w-full lg:w-auto bg-white/60 lg:bg-transparent backdrop-blur-lg lg:backdrop-blur-none border lg:border-0 border-white/30 rounded-b-2xl shadow-md lg:shadow-none space-y-4 lg:space-y-0 lg:space-x-8 p-6 lg:p-0 transition-all duration-300 ${
              open
