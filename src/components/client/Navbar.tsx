  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-transparent">
      ...
      >
        ...
        {/* links */}
        <ul
          className={`flex flex-col lg:flex-row absolute lg:static top-full left-0 w-full lg:w-auto bg-white/90 backdrop-blur-3xl shadow-md lg:bg-transparent lg:backdrop-blur-none border lg:border-0 border-white/30 lg:shadow-none space-y-4 lg:space-y-0 lg:space-x-8 p-6 lg:p-0 transition-all duration-300 ${
            open
