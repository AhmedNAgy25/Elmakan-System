  ...
  return (
    <section id={id} className="py-20 px-6 bg-gray-50">
      <div className="container mx-auto text-center">
        ...
        <div className="grid gap-4 sm:gap-6 md:gap-8 lg:gap-10 grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 mt-12">
          {successors.map((member: ITeam, index: number) => (
            <div
              key={index}
              className="flex flex-col items-center justify-between justify-items-center text-center bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-300 group"
            >
              {/* avatar */}
